...
---
title: "EXTENSOMETRIE ELECTRIQUE PAR JAUGES DE DEFORMATION"
...
![Tableau](figures/Torsion-04.png){width="40%" fig-align="center"}
...
\sigma_{xy}(x,y,z) &=  -(\dfrac{ F }{2\pi R^2}) (\dfrac{ 3 + 2\nu }{ 1 + \nu}) 
                             \left(1 - \dfrac{ y^2 }{ R^2} - \dfrac{ 1-2\nu }{3+2\nu} \dfrac{z^2}{R^2}\right) 
                             - \dfrac{2 F l_0 z}{\pi R^4} \\
\sigma_{xz}(x,y,z) &=  \dfrac{F}{\pi R^4} \dfrac{1 + 2\nu}{1 + \nu} \frac{yz}{R^2} + \frac{2 F l_0 y}{\pi R^4} 
\end{align*}
...
\text{Point 1 }(l_1, R,0) &\longrightarrow 
 \begin{bmatrix}
    \sigma_{xx}(1) =  \dfrac{4 F (l - l_1}{\pi R^4} ;& \sigma_{xy}(1) = 0  ;&  \sigma_{xz}(1) = \dfrac{2 F l_0}{\pi R^3} \\
    \end{bmatrix} \\ 
\text{Point 2 }(l_1, -R,0) &\longrightarrow 
 \begin{bmatrix}
    \sigma_{xx}(2) =  \dfrac{4 F (l - l_1}{\pi R^4} ;& \sigma_{xy}(2) = 0  ;&  \sigma_{xz}(2) = \dfrac{-2 F l_0}{\pi R^3} \\
    \end{bmatrix} \\ 
...
## Etude de la linéarité du comportement au point 2 de la jauge orientée selon $\underline{a}$
...
##  Découplage du cisaillement et de la torsion
